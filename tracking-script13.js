(function () {
  ...
  function getConfigFromQuery() {
    ...
    const trackingScript = Array.from(scripts).find(s => s.src && s.src.includes('tracking-script12'));
  ...
  function initListeners() {
    ...
    setTimeout(handleScroll, 1000); // Fallback to trigger scroll if already scrolled
